        ...
        <>
            ...
            {tam=="col-12" ? (<div className="col-12 categoria categoria-principal">
                <div className="categoria__caja categoria__caja--principal" style={{ background: item.color || 'transparent'}}>
                    ...
                    <Link className="categoria__boton categoria__boton--principal" to={item.id_category? `/category/${item.id_category}`:`/category/${item.id}`}>Browse</Link>
                ...
                <div className="categoria__caja categoria__caja--uno" style={{ background: item.color || 'transparent'}}>
                    ...
                    <Link className="categoria__boton categoria__boton--uno" to={item.id_category? `/category/${item.id_category}`:`/category/${item.id}`}>Browse</Link>
